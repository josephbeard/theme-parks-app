...
class MerlinPark extends Park {
  ...
  constructor(options = {}) {
    ...
    // API settings
    this[sAppBuild] = options.appBuild || '5';
    this[sAppVersion] = options.appVersion || '1.0.1';
    this[sDeviceID] = options.deviceID || 'cbdc5df9-76e9-4ffd-b8ad-49afd565ce5c';
  }
      ...
      return this.GenerateUserID().then((userID) => {
        ...
        return this.HTTP({
          ...
          data: {
            ...
            device_identifier: this[sDeviceID],
