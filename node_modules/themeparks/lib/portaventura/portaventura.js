...
const sParkCalendarURL = Symbol('PortAventura Calendar Data URL');
...
class PortAventura extends Park {
  ...
  constructor(options = {}) {
    ...
    this[sParkCalendarURL] = options.parkCalendarURL || 'https://www.portaventuraworld.com/static/d/259/path---en-dates-times-74-c-95b-AHmcyZmuFm7pVcLhCWeICRUEU.json';
  }
  ...
  FetchOpeningTimes() {
    return this.Cache.Wrap('openingHours', this.FetchOpeningTimesData.bind(this), 60 * 60 * 24).then((data) => {
      data.forEach((range) => {
  ...
  FetchOpeningTimesData() {
    return this.HTTP({
      url: this[sParkCalendarURL],
    }).then((data) => {
